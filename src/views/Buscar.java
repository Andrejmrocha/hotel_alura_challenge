...
public class Buscar extends JFrame {
	...
	//Código que permite movimentar a janela pela tela seguindo a posição de "x" e "y"	
	 ...
	 private List<Reserva> buscarReserva() {
		 ...
		 return this.reservaController.buscarPorNumero(txtBuscar.getText());
	 }
	 
	 private List<Hospede> buscarHospede(){
		 return this.hospedeController.buscarPorSobrenome(txtBuscar.getText());
	 }
	 
	 private void preencherTabelaReservas() {
		 modelo.setRowCount(0);
		 List<Reserva> reservaLista = buscarReserva();
		 try {
	 ...
	 private void preencherTabelaHospedes() {
		 ...
		 List<Hospede> hospedeLista = buscarHospede();
		 try {
