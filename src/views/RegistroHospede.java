...
public class RegistroHospede extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHospede frame = new RegistroHospede(idReserva);
	...
	public RegistroHospede(int id) {
		...
		txtNreserva.setText(Integer.toString(id));
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				if (RegistroHospede.txtNome.getText() != null && RegistroHospede.txtSobrenome.getText() != null 
						&& RegistroHospede.txtDataN.getDate() != null
	...
	//Código que permite movimentar a janela pela tela seguindo a posição de "x" y "y"
	 ...
	 private void salvarHospede() {
		 ...
		 hospedeController.cadastrar(hospede, idReserva);
		 JOptionPane.showMessageDialog(contentPane, "Registro salvo, Nome do Hóspede: " + hospede.getNome() 
				 + "\nNúmero da reserva: " + idReserva);
	 };
